...
NedAccel::NedAccel(): UAVDataObject(OBJID, ISSINGLEINST, ISSETTINGS, NAME)
{
    ...
    fields.append( new UAVObjectField(QString("North"), tr(""), QString("m/s^2"), UAVObjectField::FLOAT32, NorthElemNames, QStringList(), QString("")));
    QStringList EastElemNames;
    EastElemNames.append("0");
    fields.append( new UAVObjectField(QString("East"), tr(""), QString("m/s^2"), UAVObjectField::FLOAT32, EastElemNames, QStringList(), QString("")));
    QStringList DownElemNames;
    DownElemNames.append("0");
    fields.append( new UAVObjectField(QString("Down"), tr(""), QString("m/s^2"), UAVObjectField::FLOAT32, DownElemNames, QStringList(), QString("")));
