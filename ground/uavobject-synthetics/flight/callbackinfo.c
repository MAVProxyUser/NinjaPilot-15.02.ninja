...
{
    UAVObjSetDataField(CallbackInfoHandle(), (void *)NewRunningTime, offsetof(CallbackInfoData, RunningTime), 9*sizeof(uint32_t));
}
void CallbackInfoRunningTimeGet( CallbackInfoRunningTimeData *NewRunningTime )
{
    UAVObjGetDataField(CallbackInfoHandle(), (void *)NewRunningTime, offsetof(CallbackInfoData, RunningTime), 9*sizeof(uint32_t));
}
...
{
    UAVObjSetDataField(CallbackInfoHandle(), (void *)NewStackRemaining, offsetof(CallbackInfoData, StackRemaining), 9*sizeof(int16_t));
}
void CallbackInfoStackRemainingGet( CallbackInfoStackRemainingData *NewStackRemaining )
{
    UAVObjGetDataField(CallbackInfoHandle(), (void *)NewStackRemaining, offsetof(CallbackInfoData, StackRemaining), 9*sizeof(int16_t));
}
...
{
    UAVObjSetDataField(CallbackInfoHandle(), (void *)NewRunning, offsetof(CallbackInfoData, Running), 9*sizeof(uint8_t));
}
void CallbackInfoRunningGet( CallbackInfoRunningData *NewRunning )
{
    UAVObjGetDataField(CallbackInfoHandle(), (void *)NewRunning, offsetof(CallbackInfoData, Running), 9*sizeof(uint8_t));
}
void CallbackInfoRunningArraySet( uint8_t *NewRunning )
{
    UAVObjSetDataField(CallbackInfoHandle(), (void *)NewRunning, offsetof(CallbackInfoData, Running), 9*sizeof(uint8_t));
}
void CallbackInfoRunningArrayGet( uint8_t *NewRunning )
{
    UAVObjGetDataField(CallbackInfoHandle(), (void *)NewRunning, offsetof(CallbackInfoData, Running), 9*sizeof(uint8_t));
}
