...
public class ManualControlSettings extends UAVDataObject {
	...
	public ManualControlSettings() {
		...
		fields.add( new UAVObjectField("DeadbandAssistedControl", "%", UAVObjectField.FieldType.FLOAT32, DeadbandAssistedControlElemNames, null) );
	...
	{
		getField("Deadband").setValue(0.02);
		getField("DeadbandAssistedControl").setValue(0.08);
	...
	// Constants
	protected static final long OBJID = 0x28801F10l;
