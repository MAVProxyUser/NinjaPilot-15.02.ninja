...
#include <memory>
#include "../../../../../../uavobject-synthetics/gcs/faultsettings.h"
...
QT_MOC_LITERAL(4, 42, 16), // "setActivateFault"
QT_MOC_LITERAL(5, 59, 17), // "emitNotifications"
QT_MOC_LITERAL(6, 77, 16), // "getActivateFault"
QT_MOC_LITERAL(7, 94, 13) // "ActivateFault"

    },
    "FaultSettings\0ActivateFaultChanged\0\0"
    "value\0setActivateFault\0emitNotifications\0"
    "getActivateFault\0ActivateFault"
};
...
void FaultSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ActivateFaultChanged((*reinterpret_cast< quint8(*)>(_a[1]))); break;
        case 1: _t->setActivateFault((*reinterpret_cast< quint8(*)>(_a[1]))); break;
        case 2: _t->emitNotifications(); break;
        case 3: { quint8 _r = _t->getActivateFault();
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< quint8*>(_v) = _t->getActivateFault(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setActivateFault(*reinterpret_cast< quint8*>(_v)); break;
        default: break;
        }
