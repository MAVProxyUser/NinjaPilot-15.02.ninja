...
#include <memory>
#include "../../../../../../uavobject-synthetics/gcs/flightplansettings.h"
...
QT_MOC_LITERAL(4, 38, 7), // "setTest"
QT_MOC_LITERAL(5, 46, 17), // "emitNotifications"
QT_MOC_LITERAL(6, 64, 7), // "getTest"
QT_MOC_LITERAL(7, 72, 4) // "Test"

    },
    "FlightPlanSettings\0TestChanged\0\0value\0"
    "setTest\0emitNotifications\0getTest\0"
    "Test"
};
...
void FlightPlanSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->TestChanged((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 1: _t->setTest((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 2: _t->emitNotifications(); break;
        case 3: { float _r = _t->getTest();
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< float*>(_v) = _t->getTest(); break;
        default: break;
        }
