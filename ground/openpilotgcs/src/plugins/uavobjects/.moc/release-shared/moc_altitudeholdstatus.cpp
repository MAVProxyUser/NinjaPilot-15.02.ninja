...
#include <memory>
#include "../../../../../../uavobject-synthetics/gcs/altitudeholdstatus.h"
...
QT_MOC_LITERAL(4, 49, 18), // "setVelocityDesired"
QT_MOC_LITERAL(5, 68, 17), // "emitNotifications"
QT_MOC_LITERAL(6, 86, 18), // "getVelocityDesired"
QT_MOC_LITERAL(7, 105, 15) // "VelocityDesired"

    },
    "AltitudeHoldStatus\0VelocityDesiredChanged\0"
    "\0value\0setVelocityDesired\0emitNotifications\0"
    "getVelocityDesired\0VelocityDesired"
};
...
void AltitudeHoldStatus::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->VelocityDesiredChanged((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 1: _t->setVelocityDesired((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 2: _t->emitNotifications(); break;
        case 3: { float _r = _t->getVelocityDesired();
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< float*>(_v) = _t->getVelocityDesired(); break;
        default: break;
        }
