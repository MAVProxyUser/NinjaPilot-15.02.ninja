...
#include <memory>
#include "../../../../../../uavobject-synthetics/gcs/waypointactive.h"
...
QT_MOC_LITERAL(4, 35, 8), // "setIndex"
QT_MOC_LITERAL(5, 44, 17), // "emitNotifications"
QT_MOC_LITERAL(6, 62, 8), // "getIndex"
QT_MOC_LITERAL(7, 71, 5) // "Index"

    },
    "WaypointActive\0IndexChanged\0\0value\0"
    "setIndex\0emitNotifications\0getIndex\0"
    "Index"
};
...
void WaypointActive::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setIndex((*reinterpret_cast< qint16(*)>(_a[1]))); break;
        case 2: _t->emitNotifications(); break;
        case 3: { qint16 _r = _t->getIndex();
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< qint16*>(_v) = _t->getIndex(); break;
        default: break;
        }
