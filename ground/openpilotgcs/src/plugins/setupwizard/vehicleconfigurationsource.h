...
public:
    ...
    enum CONTROLLER_TYPE { CONTROLLER_UNKNOWN, CONTROLLER_CC, CONTROLLER_CC3D, CONTROLLER_REVO, CONTROLLER_REALPOSIX, CONTROLLER_ESP32, CONTROLLER_LITEWING, CONTROLLER_NANO, CONTROLLER_OPLINK, CONTROLLER_DISCOVERYF4, CONTROLLER_CUBE };
    ...
    enum ESC_TYPE { ESC_ONESHOT, ESC_SYNCHED, ESC_RAPID, ESC_STANDARD, ESC_BRUSHED, ESC_UNKNOWN };
    ...
    enum GPS_TYPE { GPS_PLATINUM, GPS_UBX, GPS_NMEA, GPS_DISABLED, GPS_DRONECAN };
