...
void GLC_Factory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GLC_Factory *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (GLC_Factory::*)(int ) const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GLC_Factory::currentQuantum)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GLC_Factory::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_GLC_Factory.data,
    qt_meta_data_GLC_Factory,
    qt_static_metacall,
    nullptr,
    nullptr
} };
