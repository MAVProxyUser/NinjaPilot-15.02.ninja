...
void GLC_WorldTo3dxml::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GLC_WorldTo3dxml *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (GLC_WorldTo3dxml::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GLC_WorldTo3dxml::currentQuantum)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GLC_WorldTo3dxml::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_GLC_WorldTo3dxml.data,
    qt_meta_data_GLC_WorldTo3dxml,
    qt_static_metacall,
    nullptr,
    nullptr
} };
