...
void mapcontrol::GPSItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GPSItem *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (GPSItem::*)(int const & , WayPointItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GPSItem::UAVReachedWayPoint)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GPSItem::*)(internals::PointLatLng const & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GPSItem::UAVLeftSafetyBouble)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (GPSItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GPSItem::setChildPosition)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (GPSItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GPSItem::setChildLine)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject mapcontrol::GPSItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_mapcontrol__GPSItem.data,
    qt_meta_data_mapcontrol__GPSItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
