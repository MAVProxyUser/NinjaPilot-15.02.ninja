...
#define configMAX_PRIORITIES                         8  /* as the F1 board: the callback scheduler of this tree needs them, see pios_callbackscheduler.h */
#define configMINIMAL_STACK_SIZE                     512
#define configTOTAL_HEAP_SIZE                        (180 * 1024)  // this is minimum, not total
