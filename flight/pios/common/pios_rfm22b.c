...
static const uint8_t __attribute__((unused)) FULL_PREAMBLE[FIFO_SIZE] = {
...
static const uint8_t __attribute__((unused)) HEADER[(TX_PREAMBLE_NIBBLES + 1) / 2 + 2] = {
...
static const uint8_t __attribute__((unused)) num_channels[] = { 32, 32, 32, 32, 32, 32, 32, 32, 32 };
