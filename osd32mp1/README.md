...
| Live sensors | MPU-9150 @ 500 Hz (1440 free-run max), HMC5883L @ 69 Hz max, BMP280 @ 22 Hz (MP1 I2C); MPU-9150 raw proxy 958 Hz (sensor-limited: MPU-9150 accel ODR; guardrail v3), BMP388 @ 50 Hz, RM3100 @ 25 Hz, IST8310 @ 97 Hz max, GNSS @ 10 Hz (20 max) (CAN) |
...
| MPU-9150 #2 gyro+accel | DroneCAN, L431 I2C | node 124, msg 20500/20501 | **958 Hz** | live — RAW-count proxy (no cal/filter on the node), 400 kHz bus, hard-clamped 600 with guardrail v3 (pool-occupancy wire-health, tiered backoff to a 100 Hz floor, 10 s boot soft-start); realposix failover IMU |
...
|---|---|---|---|
| IMU rate | MPU-9150 #1: **493 Hz** paced (1440 free-run) | MPU-9150 #2: **958 Hz** sustained | the CAN IMU runs at the SENSOR's own 1 kHz accel ceiling |
